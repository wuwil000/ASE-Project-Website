...
#define front_right_motor = Motor(Ports.PORT1, False);
#define front_left_motor = Motor(Ports.PORT3, False);
#define back_right_motor = Motor(Ports.PORT5, False);
#define back_left_motor = Motor(Ports.PORT7, False);
